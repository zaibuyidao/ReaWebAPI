...
- Dock/Undock from the WebView context menu and PNG, ICO or SVG window icons from HTML favicons, with explicit overrides through `reaper.window.setIcon(path)`.
