    ...
    def test_exact_reapack_layout(self):
        ...
        with zipfile.ZipFile(self.directory / f'ReaWebAPI-ReaPack-v{self.version}.zip') as bundle:
            ...
            self.assertCountEqual([target for mode, target, _ in entries if mode == 'main'],
                             ['web/ReaWebAPI_Demo.lua', 'web/lua-backend/reawebapi-lua-backend.lua', 'web/native-service/reawebapi-native-service.lua', 'web/native-service/Coexist.lua', 'web/native-stream/reawebapi-native-stream.lua'])
