...
def descriptor(version, demo_directory=None):
    ...
    for path in entries:
        ...
        options = 'script main' if name in ('ReaWebAPI_Demo.lua', 'lua-backend/Open.lua', 'native-service/Open.lua', 'native-service/Coexist.lua', 'native-stream/Open.lua') else 'script nomain'
